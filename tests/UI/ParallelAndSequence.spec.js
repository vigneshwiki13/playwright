...
test.describe.configure({ mode: "parallel" })  //run with multiple workers, all test in parallel modw
// test.describe.configure({ mode: "serial" })   // if 1st fail it skips the remaining
