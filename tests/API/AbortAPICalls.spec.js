...
test(" ECommerce", async({page})=>{
 ...
 const txtCountryElement= page.locator("[placeholder*=Country]");
   ...
   //removes all the css styles, images 
   
   page.on('request', request=> console.log(request.url()));
   //  on is the listerner, whenever the request call made it will activated
   page.on('response', response=> console.log(response.status()));
   //  whenever a response will generated its status code will be printed
